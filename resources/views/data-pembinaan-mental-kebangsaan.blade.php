            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-700">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Kategori Kegiatan</th>
                            <th scope="col" class="px-6 py-3">Tingkat Kegiatan</th>
                ...
                <nav class="flex items-center flex-column flex-wrap md:flex-row justify-between pt-4" aria-label="Table navigation">
                    <span class="text-sm font-normal text-gray-500 mb-4 md:mb-0 block w-full md:inline md:w-auto">
                        <span class="font-semibold text-gray-900">Data</span> Pembinaan Mental Kebangsaan <span class="font-semibold text-gray-900">UPR</span>
                    </span>
